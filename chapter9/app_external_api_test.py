...
from chapter9.app_external_api import app, external_api
...
class MockExternalAPI:
    mock_data = {
        "products": [
            {
                "id": 1,
                "title": "FastAPI the fast rising api development framework",
                "description": "FastAPI is very easy to use API with good documentation",
                "thumbnail": "https://i.dummyjson.com/thumbnail.jpg",
            },
        ],
        "total": 1,
        "skip": 0,
